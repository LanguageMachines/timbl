...
{\bf version 7.0} \\ \vspace*{0.5cm}{\huge Reference Guide}}
...
The current release (version 7.0) is the result of a long series of
...
elaborate description of the changes from version 1.0 up to 7.0 can be
...
In publication of research that makes use of TiMBL 7.0, a citation
should be given of: {\em ``Walter Daelemans, Jakub Zavrel, Ko van der
  ...
  Learner, version 7.0, Reference Guide.
  Available from \\ {\tt
    https://languagemachines.github.io/timbl}''}

For information about commercial licenses for TiMBL 7.0,
...
{\tt > tar xfz timbl-7.0.tar.gz}

This will make a directory {\tt timbl-7.0} under your current
...
also created: {\tt share/doc/timbl} where the TiMBL 7.0 documentation
...
released versions (1.0 up to 7.0) for users already familiar with the
program.

\section{From version 6.4 to 7.0}

Between version 6.4 and 7.0, TiMBL saw a long series of incremental
